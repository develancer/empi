...
void test_product() {
    ...
    ASSERT_APPROX(1.0, calculator.calculate_squared_product(x0, x0), 1.0e-6);
    ...
    ASSERT_APPROX(expected, calculator.calculate_squared_product(x0, xf), 1.0e-6);
    ASSERT_APPROX(expected, calculator.calculate_squared_product(x0, xt), 1.0e-6);
    ASSERT_APPROX(expected, calculator.calculate_squared_product(x0, xs), 2.0e-6);
}
